        ...
        <div className="grid">
            <div className="col-12 lg:col-12 xl:col-4">
                <div className="card mb-0">
                    <div className="flex justify-content-between mb-3">
                        <div>
                            <span className="block text-500 font-medium mb-3">Total Meetings Today</span>
            ...
            <div className="col-12 lg:col-12 xl:col-4">
                <div className="card mb-0">
                    <div className="flex justify-content-between mb-3">
                        <div>
                            <span className="block text-500 font-medium mb-3">Total Meetings This Week</span>
            ...
            <div className="col-12 lg:col-12 xl:col-4">
                <div className="card mb-0">
                    <div className="flex justify-content-between mb-3">
                        <div>
                            <span className="block text-500 font-medium mb-3">Total Commission This Month</span>
                            <div className="text-900 font-medium text-xl">2,888</div>
                        </div>
                    ...
                    <span className="text-500">more than last month</span>
                </div>
            </div>
